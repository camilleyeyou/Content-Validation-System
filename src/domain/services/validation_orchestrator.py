...
UPDATED: Images now generated by dedicated agent and preserved through revisions
"""
...
class ValidationOrchestrator:
    ...
    async def _process_single_post(self, post: LinkedInPost) -> LinkedInPost:
        ...
        while True:
            ...
            if post.can_revise():
                ...
                original_image_generation_time = getattr(post, 'image_generation_time', None)
                ...
                if original_image_url and not post.image_url:
                    ...
                    post.set_image(
                        ...
                        generation_time=original_image_generation_time
                    )
    ...
    async def _generate_initial_posts(self, batch_id: str, count: int) -> List[LinkedInPost]:
        ...
        # Convert to LinkedInPost objects (without worrying about images yet)
        posts = []
