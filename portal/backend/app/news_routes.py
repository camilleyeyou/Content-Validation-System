...
"""
News API Routes - Provides news headlines for wizard inspiration
Uses NewsAPI.org (free tier: 100 requests/day)
Follows the same pattern as other route files in this directory
"""
...
# Import from src/infrastructure/news (already in sys.path via main.py)
from src.infrastructure.news import (
    get_news_service,
